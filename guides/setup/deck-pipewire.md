# pipewire-jack on SteamOS

(Thanks to [BWagener](https://github.com/BWagener) for writing this.)

(I (Nizo) don't own a SteamOS device, but am the only maintainer currently. I therefore rely on reports of other people and try to keep this up to date as best as possible.)
