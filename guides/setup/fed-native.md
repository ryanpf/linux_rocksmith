...
```
sudo dnf install -y gcc make glibc-devel.i686 wine wine-devel.i686 wine-devel.x86_64 jack-audio-connection-kit-devel.* realtime-setup pavucontrol qpwgraph qjackctl
